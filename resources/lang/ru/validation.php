...
return [
    ...
    */
    ...
    'decimal' => 'Поле :attribute должно содержать :decimal знаки.',
    ...
    'doesnt_start_with' => ':attribute не может начинаться со следующих значений: :values.',
    ...
    'lowercase' => ':attribute должно быть строчным регистром.',
    'lt' => [
    ...
    'password' => [
        'letters' => ':attribute должно содержать минимум одну букву.',
        'mixed' => 'Поле :attribute должно содержать как минимум по одному символу в нижнем и верхнем регистрах.',
        'numbers' => 'Поле :attribute должно содержать минимум одну цифру.',
        'symbols' => 'Поле :attribute должно содержать минимум один спец символ.',
        'uncompromised' => 'Значение поля :attribute обнаружено в утечке данных. Пожалуйста, укажите другое значение для :attribute.',
    ],
    ...
    'uppercase' => ':attribute должен быть заглавным.',
    ...
    */
    ...
    'attributes' => [
        ...
        'code' => 'код',
        'color' => 'цвет',
        'conditions' => 'Условия Соглашения',
        'content' => 'содержание',
        'description' => 'описание',
        'email' => 'адрес эл. почты',
        'icon' => 'значок',
        'image' => 'изображение',
        'join_url' => 'ссылка-приглашение',
        'link' => 'ссылка',
        'money' => 'деньги',
        'name' => 'название',
        'page' => 'страница',
