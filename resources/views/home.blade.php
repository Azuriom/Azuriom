...
=======
    <div class="home-background d-flex align-items-center justify-content-center flex-column text-white mb-4" style="background: url('{{ setting('background') ? image_url(setting('background')) : 'https://placehold.co/2000x500' }}') center / cover no-repeat; height: 500px">
>>>>>>> upstream/master
