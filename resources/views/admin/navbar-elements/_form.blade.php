...
<div data-nav-element="page" class="form-group d-none">
    <label for="pageSelect">{{ trans('admin.navbar_elements.fields.page') }}</label>
...
<div data-nav-element="post" class="form-group d-none">
    <label for="postSelect">{{ trans('admin.navbar_elements.fields.post') }}</label>
...
<div class="form-group custom-control custom-switch">
    ...
    <label class="custom-control-label" for="newTabSwitch">{{ trans('admin.navbar_elements.fields.new-tab') }}</label>
</div>
...
<div class="form-group mb-2">
    <div class="custom-control custom-switch">
        ...
        <label class="custom-control-label" for="restrictedSwitch">{{ trans('admin.navbar_elements.restrict') }}</label>
    </div>
</div>
