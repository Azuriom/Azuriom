            ...
            <form action="{{ route('admin.settings.update') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select class="form-select @error('locale') is-invalid @enderror" id="localeSelect" name="locale[]" required multiple>
                            @foreach($locales as $localeCode => $localeName)
                                <option value="{{ $localeCode }}" @selected(in_array($localeCode, get_selected_locales_codes()))>
                                    {{ $localeName }}
                                </option>
                            @endforeach
                        </select>
